...
public class SymbolTable implements Cloneable {
  ...
  public LinkedHashMap<String, Symbol> getVariables() { return this.variables; }
  ...
  public void setRegisters(String functionName) {
    ...
    if (this.returnSymbol != null) {
      ...
      System.out.println(this.returnSymbol.getName() + " - " +
      this.returnSymbol.getRegister());
    }
  ...
  public int getLastRegister() { return lastRegister; }
  ...
  public void setLocals(int locals) { this.locals = locals; }

  public int getLoopCounter() { return loopCounter; }

  public void incLoopCounter() { this.loopCounter++; }
